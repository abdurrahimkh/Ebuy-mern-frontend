...
const AdminLogin = () => {
  ...
  return (
    <div className="bg-blackone h-screen flex justify-center items-center">
      <form
        className="bg-blacktwo p-5 w-10/12 sm:w-8/12 md:w-6/12 lg:w-4/12 rounded"
      ...
      >
        ...
        <div className="mb-4 mt-4">
          <input
            type="email"
            name="email"
            className="w-full bg-blackone p-4 rounded outline-none text-white"
